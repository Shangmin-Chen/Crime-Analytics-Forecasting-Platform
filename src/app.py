...
def render_footer():
    """Render styled footer with GitHub link and copyright."""
    st.markdown("---")
    ...
    <div style="display: flex; flex-direction: column; align-items: center; gap: 12px; padding: 20px 0; text-align: center;">
        <div style="display: flex; align-items: center; justify-content: center; gap: 8px;">
            <a 
                href="https://github.com/Shangmin-Chen/CrimeMapper-Boston" 
                target="_blank" 
                rel="noopener noreferrer"
                style="display: flex; align-items: center; gap: 8px; color: #6b7280; text-decoration: none; transition: color 0.2s;"
            ...
            >
                ...
                <span style="font-weight: 500;">GitHub Repository</span>
            </a>
        </div>
        <p style="font-size: 0.875rem; color: #6b7280; margin: 0;">
            &copy; 2025 CrimeMapper-Boston. Powered by 
            <a 
                href="https://data.boston.gov/api/3/action/datastore_search" 
                target="_blank" 
                rel="noopener noreferrer"
